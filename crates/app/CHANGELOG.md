...
## [0.3.2](https://github.com/dinosath/ferris-cms/compare/ferriscms-v0.3.1...ferriscms-v0.3.2) - 2026-09-17

### Added

- *(build)* rustls-only deps + immutable release artifacts
- *(ui)* node-link dependency visualization for computed fields
- *(computed)* tested expression evaluator + CTB syntax highlighting/preview
- *(ui,computed)* CTB field autocomplete, dependency graph, DDL preview
- *(ui,docs)* computed fields in CTB + read-only admin rendering
...
## [0.3.0](https://github.com/dinosath/ferris-cms/compare/ferriscms-v0.2.0...ferriscms-v0.3.0) - 2026-09-15
...
## [0.2.0](https://github.com/dinosath/ferris-cms/releases/tag/ferriscms-v0.2.0) - 2026-09-15
